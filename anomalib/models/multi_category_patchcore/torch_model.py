...
class Multi_Category_PatchcoreModel(DynamicBufferModule, nn.Module):
    """Patchcore Module."""
    ...
    def __init__(
        ...
        self.classifier = torch.load(f'{classifier}.pth')
    ...
    def nearest_neighbors(self, embedding: Tensor, n_neighbors: int = 9) -> Tensor:
        ...
        distances = torch.cdist(
            embedding, self.memory_bank, p=2.0)  # euclidean norm
