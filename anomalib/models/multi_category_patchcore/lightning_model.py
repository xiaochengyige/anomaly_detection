...
from anomalib.models.multi_category_patchcore.torch_model import Multi_Category_PatchcoreModel

logger = logging.getLogger(__name__)


@MODEL_REGISTRY
class Multi_Category_Patchcore(AnomalyModule):
    ...
    def __init__(
        ...
        self.model: Multi_Category_PatchcoreModel = Multi_Category_PatchcoreModel(
        ...
        self.embeddings: List[List[Tensor]] = [[]
    ...
    def training_step(self, batch, _batch_idx):  # pylint: disable=arguments-differ
        ...
        categories = batch["category_label"]
...
class Multi_Category_PatchcoreLightning(Multi_Category_Patchcore):
    """PatchcoreLightning Module to train PatchCore algorithm.
